...
# Backwards-compatible names for the original public GRPO data API.
GRPOCollator = PromptCollator


def tokenize_grpo(example, tokenizer, max_prompt_length=None, prompt_field="prompt"):
