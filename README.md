...
├── grpo_trainer.py    # GRPOTrainer — online rollout/reward loop
├── rewards.py         # RewardFn protocol
├── config.py          # TrainingConfig + GRPOConfig dataclasses
